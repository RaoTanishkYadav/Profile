...
<head>
  ...
  <title>Tanishk Kumar — Profile</title>
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap" rel="stylesheet">
  <style>
    :root{
      --bg1:#6a11cb;   /* gradient start */
      --bg2:#2575fc;   /* gradient end   */
      --card:#ffffff1a; /* glass card */
      --border:#ffffff33;
      --text:#f7f8fb;
      --muted:#d8def5;
      --accent:#ffd166;
    ...
    *{box-sizing:border-box}
    ...
    body{
      ...
      color:var(--text);
      background:
        radial-gradient(1200px 1200px at 10% 20%, #ff6ec7 0%, transparent 50%),
        radial-gradient(1000px 1000px at 90% 10%, #00f5d4 0%, transparent 45%),
